CREATE EXTERNAL TABLE `fo_service_order`(
...
STORED AS parquet
LOCATION
  'hdfs://localhost:9000/user/hive/warehouse/yc_bit.db/fo_service_order'




CREATE EXTERNAL TABLE `fo_service_order_ext`(
  `service_order_id` bigint,
  `operator_id` int,
  `user_type` tinyint,
  `sms` string,
...
STORED AS parquet
LOCATION
  'hdfs://localhost:9000/user/hive/warehouse/yc_bit.db/fo_service_order_ext'



CREATE EXTERNAL TABLE `geo_order_position`(
  `city` string,
  `service_order_id` bigint,
  `user_id` bigint,
  `driver_id` bigint,
...
STORED AS parquet
LOCATION
  'hdfs://localhost:9000/user/hive/warehouse/yc_bit.db/geo_order_position'



CREATE EXTERNAL TABLE `ods_service_order`(
  `service_order_id` bigint,
  `product_type_id` int,
  `fixed_product_id` int,
  `city` string,
...
STORED AS parquet
LOCATION
  'hdfs://localhost:9000/user/hive/warehouse/yc_bit.db/ods_service_order'



CREATE EXTERNAL TABLE `ods_service_order_charge`(
  `service_order_id` bigint,
...
STORED AS parquet
LOCATION
  'hdfs://localhost:9000/user/hive/warehouse/yc_bit.db/ods_service_order_charge'
